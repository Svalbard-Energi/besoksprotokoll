...
function Et(e, t) {
  ...
  if (a?.textContent) {
    ...
    return (
      o && M.set(n, { body: r, init: i, ttl: 1e3 * Number(o) }),
...
const A = globalThis.__sveltekit_14tfucw?.base ?? "",
  Ot = globalThis.__sveltekit_14tfucw?.assets ?? A ?? "",
  $t = "1763478199185",
...
const Vt = new Set(["icon", "shortcut icon", "apple-touch-icon"]),
  q = Ye(Je) ?? {},
  H = Ye(He) ?? {},
  C = { url: Fe({}), page: Fe({}), navigating: Se(null), updated: Ct() };
function Te(e) {
  q[e] = le();
}
function Bt(e, t) {
...
async function hn(e, t, n) {
  globalThis.__sveltekit_14tfucw?.data && globalThis.__sveltekit_14tfucw.data,
...
async function je({ status: e, error: t, url: n, route: a }) {
  ...
  try {
    ...
    if (o instanceof Re) return Gt(new URL(o.location, location.href), {}, 0);
    throw o;
  }
}
async function Xt(e) {
    ...
    const a = (async () => {
      let r =
        (await v.hooks.reroute({
          url: new URL(e),
          fetch: async (i, o) => zt(i, o, e).promise,
        })) ?? e;
      if (typeof r == "string") {
        const i = new URL(e);
  ...
  (history.scrollRestoration = "manual"),
    ...
    O.addEventListener("click", async (t) => {
      ...
      if (f !== void 0 && h) {
        ...
        if (((G = !0), Te(y), e(a), !s.replace_state)) return;
        G = !1;
      }
      t.preventDefault(),
        await new Promise((w) => {
