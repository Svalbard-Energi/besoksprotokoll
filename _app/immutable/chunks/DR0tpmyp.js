...
import { o as Ve } from "./DnkeOe0L.js";
const V = [];
function Se(e, t = he) {
  let n = null;
  const a = new Set();
...
function Et(e, t) {
  ...
  if (a?.textContent) {
    ...
    return (
      o && G.set(n, { body: r, init: i, ttl: 1e3 * Number(o) }),
...
const A = globalThis.__sveltekit_1tg8za3?.base ?? "",
  Ot = globalThis.__sveltekit_1tg8za3?.assets ?? A ?? "",
  $t = "1763478133896",
...
function Ct() {
  ...
  async function a() {
    clearTimeout(n);
    try {
      const r = await fetch(`${Ot}/besoksprotokoll/_app/version.json`, {
...
let k, Y, _e;
const Dt =
  Ve.toString().includes("$$") || /function \w+\(\) \{\}/.test(Ve.toString());
Dt
  ? ((k = {
      data: {},
      form: null,
...
const Vt = new Set(["icon", "shortcut icon", "apple-touch-icon"]),
  q = Ye(Je) ?? {},
  H = Ye(He) ?? {},
  C = { url: Ke({}), page: Ke({}), navigating: Se(null), updated: Ct() };
function Te(e) {
  q[e] = le();
}
function zt(e, t) {
...
async function hn(e, t, n) {
  globalThis.__sveltekit_1tg8za3?.data && globalThis.__sveltekit_1tg8za3.data,
...
async function Ft(e, t, n, a) {
  ...
  t.invalidateAll && be(),
    await K({
      ...
      nav_token: a,
      accept: () => {
        t.invalidateAll && ((Oe = !0), (r = [...Me.keys()])),
...
function ie({
  ...
  const c = {
    ...
    props: { constructors: Nt(n).map((u) => u.node.component), page: qe(k) },
  };
...
async function je({ status: e, error: t, url: n, route: a }) {
  ...
  try {
    ...
    if (o instanceof Re) return Ft(new URL(o.location, location.href), {}, 0);
    throw o;
  }
}
async function Xt(e) {
    ...
    const a = (async () => {
      let r =
        (await v.hooks.reroute({
          url: new URL(e),
          fetch: async (i, o) => Mt(i, o, e).promise,
        })) ?? e;
      if (typeof r == "string") {
        const i = new URL(e);
...
async function K({
  ...
  if (oe) {
    ...
    const D = S && (await S);
    D ? (E = D.commit()) : ($e.$set(d.props), at(d.props.page), (E = mt?.())),
      (it = !0);
  ...
  (history.scrollRestoration = "manual"),
    ...
    O.addEventListener("click", async (t) => {
      ...
      if (f !== void 0 && h) {
        ...
        if (((F = !0), Te(y), e(a), !s.replace_state)) return;
        F = !1;
      }
      t.preventDefault(),
        await new Promise((w) => {
